...
urlpatterns = [
    ...
    path('philosophers/', views.PhilosopherListView.as_view(),
         name='philosopher_list'),
    path('philosopher/<int:pk>', views.PhilosopherDetailView.as_view(),
         name='philosopher_detail'),
    path('philosopher/<int:pk>/quotes',
         views.PhilosopherQuoteListView.as_view(), name='philosopher_quotes'),
    ...
    path('quote_theme/<int:pk>/',
         views.ThemeQuotesView.as_view(), name='quote_theme'),
    path('quote_from_mood/<str:mood>/',
         views.GetQuoteFromMoodView, name='quote_from_mood'),
    path('profile/<int:td>', views.ProfileView, name='profile'),
